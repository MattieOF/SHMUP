...
func FilesToBottom() -> void:
	...
	var bottomDockContainer = get_tree().root.get_node("@EditorNode@17664/@Control@697/@Panel@698/@VBoxContainer@706/@HSplitContainer@709/@HSplitContainer@717/@HSplitContainer@725/@VBoxContainer@726/@VSplitContainer@728/@PanelContainer@7498/@VBoxContainer@7499/@HBoxContainer@7500/@HBoxContainer@7501")
	FileDockButton = bottomDockContainer.get_child(15)
